...
class J2StoreModelCartsBehaviorCartVariableSubscriptionproduct extends F0FModelBehavior {
...
//			
	...
	public function onGetCartItems(&$model, &$item) {
		...
		//sanity check
		if($item->product_type != 'variablesubscriptionproduct') return;
	...
	public function onValidateCart(&$model, $cartitem, $quantity) {
		...
		//sanity check
		if($cartitem->product_type != 'variablesubscriptionproduct') return;
