	          ...
	          <div class="tabbable tabs-left">
                ...
                <div class="tab-content">
                  ...
                  <input type="hidden" name="<?php echo $this->form_prefix.'[j2store_variant_id]'; ?>" value="<?php echo $this->item->variant->j2store_variant_id; ?>" />
                	<?php echo $this->loadTemplate('variablesubscriptionproduct_general');?>
                  </div>
                  ...
                  <div class="tab-pane" id="variantsTab">
					<?php echo $this->loadTemplate('variablesubscriptionproduct_options');?>
					<?php echo $this->loadTemplate('variablesubscriptionproduct_variants'); ?>
                  </div>
