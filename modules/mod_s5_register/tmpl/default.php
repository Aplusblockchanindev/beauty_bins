...

{
	  ...
	  if(response == 'useractivate')
	  {
		  ...
		  document.getElementById('s5_regresponse').innerHTML = "<?php echo JText::_('COM_USERS_REGISTRATION_COMPLETE_VERIFY'); ?> ";
	  }else if(response == 'adminactivate'){
		  document.getElementById("s5_regresponse").style.display = "block";
		  document.getElementById("josForm").style.display = "none";
		  document.getElementById('s5_regresponse').innerHTML = "<?php echo JText::_('COM_USERS_REGISTRATION_COMPLETE_ACTIVATE'); ?> ";
	  }else if(response == 'simple'){
		  document.getElementById("s5_regresponse").style.display = "block";
		  document.getElementById("josForm").style.display = "none";
		  document.getElementById('s5_regresponse').innerHTML = "<?php echo JText::_('COM_USERS_REGISTRATION_SAVE_SUCCESS'); ?>";  
	  }else if(response == 'error'){
		  document.getElementById("s5_regresponse").style.display = "block";
		  document.getElementById('s5_regresponse').innerHTML = "<?php echo JText::_('COM_USERS_REGISTRATION_SAVE_FAILED'); ?>";  
	  }else{
		  document.getElementById("s5_regresponse").style.display = "block";
