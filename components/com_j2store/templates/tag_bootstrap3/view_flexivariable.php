        ...
        <div class="col-sm-6">
            ...
            <div class="price-sku-brand-container row">
                ...
                <div class="col-sm-6">
                    ...
                    <?php endif;?>
                    <?php if($this->params->get('item_show_product_sku', 1) && isset($this->product->variant->sku) && !empty($this->product->variant->sku)) : ?>
                    ...
                    <?php elseif ($this->params->get('item_show_product_sku', 1)) : ?>
                        <div class="product-sku">
                            <span class="sku-text"><?php echo JText::_('J2STORE_SKU')?></span>
                            <span class="sku"></span>
                        </div>
