...
<div class="options">
        ...
        <?php //var_dump($option); ?>
		<?php //var_dump("Modified by DC Web");?>
	...
	<div id="option-<?php echo $option['productoption_id']; ?>"
		...
		<div class="label_field">
          ...
          <?php } ?>
          <b class="option_title"><?php echo $this->escape(JText::_($option['option_name'])); ?>:</b>
		  </div> 
		  ...
		  <select id="qty_selector_<?php echo $option['productoption_id']; ?>" name="product_option[<?php echo $option['productoption_id']; ?>]"
