...
if(count($this->vars->upcoming_renewals)){
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
        <?php
        foreach ($this->vars->upcoming_renewals as $item):?>
            <tr>
                <td>
...
<?php } else {
    echo JText::_('J2STORE_SUBSCRIPTION_NO_UPCOMING_RENEWALS');
} ?>
