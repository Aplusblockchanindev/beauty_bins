...
echo J2Store::plugin()->eventWithHtml('DisplayAdditionalContentBeforeRelatedOrders', array($this->vars->subscription) );
?>
    ...
    <div>
        <table class="j2store-cart-table table table-bordered">
            ...
            <tbody>
                <tr>
                    <td>
                        <?php $orderUrl = JRoute::_('index.php?option=com_j2store&view=myprofile&task=vieworder&tmpl=component&order_id='.$this->vars->order->order_id); ?>
                        <?php echo J2StorePopup::popup($orderUrl, $this->vars->order->order_id, array('class'=>''));?>
                    </td>
                    <td>
                        <?php
                    ...
                    <td>
                        ...
                        <?php
                        echo J2Store::plugin()->eventWithHtml('DisplayAdditionalContentAfterParentOrderStatusInSubscription', array($this->vars->order) );
                        ?>
                    </td>
                    <td>
                ...
                foreach($relatedOrders as $relatedOrder):
                    ...
                    <tr>
                        <td>
                            <?php $orderUrl = JRoute::_('index.php?option=com_j2store&view=myprofile&task=vieworder&tmpl=component&order_id='.$relatedOrder->order_id); ?>
                            <?php echo J2StorePopup::popup($orderUrl, $relatedOrder->order_id, array('class'=>''));?>
                        </td>
                        <td>
                            <?php
                        ...
                        <td>
                            ...
                            <?php
                            echo J2Store::plugin()->eventWithHtml('DisplayAdditionalContentAfterEachRelatedOrderStatusInSubscription', array($relatedOrder) );
                            ?>
                        </td>
                        <td>
                            <?php echo J2Store::currency()->format($relatedOrder->order_total, $relatedOrder->currency_code, $relatedOrder->currency_value); ?>
                        </td>
                    </tr>
                    <?php
                endforeach;
