...
<br />
<br />
We wanted to let you know that your subscription for the Product <b><?php echo $vars->product->product_name; ?></b> will be renewed automatically on <?php echo $renewalDate; ?>.
<br />
<br />
Thank you.
