...
<?php if ($vars->form_type == "normal"): ?>
    <table id="#stripe_form" class="table">

        <tr>
            <td class="field_name"><?php echo JText::_('J2STORE_STRIPE_CARDHOLDER_NAME') ?></td>
            <td><input type="text" class="required" name="cardholder"
                       ...
                       title="<?php echo JText::_('J2STORE_STRIPE_VALIDATION_ENTER_CARDHOLDER_NAME'); ?>"
                />
        ...
        <tr>
            ...
            <td>
                <input type="text"
                       ...
                       title="<?php echo JText::_('J2STORE_STRIPE_VALIDATION_ENTER_CREDITCARD'); ?>"
                />
                <div class="j2error"></div>
            </td>
        ...
        <tr>
            ...
            <td>
                <select name="month" class="required number"
                        title="<?php echo JText::_('J2STORE_STRIPE_VALIDATION_ENTER_EXPIRY_MONTH'); ?>"
                >
                ...
                <select name="year" class="required number"
                        title="<?php echo JText::_('J2STORE_STRIPE_VALIDATION_ENTER_EXPIRY_YEAR'); ?>"
                >
                ...
                <div class="j2error"></div>
                <input type="hidden" class="" name="cardexp" size="10"
                       value="<?php echo !empty($vars->prepop['x_exp_date']) ? ($vars->prepop['x_exp_date']) : '' ?>"/>
            </td>
        </tr>
        <tr>
            ...
            <td><input type="text" class="required number" name="cardcvv" size="10" value=""
                       title="<?php echo JText::_('J2STORE_STRIPE_VALIDATION_ENTER_CARD_CVV'); ?>"
                />
                <div class="j2error"></div>
            </td>
        </tr>
    </table>
    <?php if ($vars->version <= '2.8.8'): ?>
